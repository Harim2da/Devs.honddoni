...
public class PageInfoPostDTO implements java.io.Serializable {
   ...
   public PageInfoPostDTO() {}

   public PageInfoPostDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage, int endPage,
