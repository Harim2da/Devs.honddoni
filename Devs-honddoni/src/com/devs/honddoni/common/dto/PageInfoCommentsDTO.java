...
public class PageInfoCommentsDTO implements java.io.Serializable {
	...
	public PageInfoCommentsDTO() {}

	public PageInfoCommentsDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
	...
	public String toString() {
		return "PageInfoCommentsDTO [pageNo=" + pageNo + ", totalCount=" + totalCount + ", limit=" + limit
