...
public class AllBoardList11 extends JFrame{

	private JFrame mainframe = new JFrame(); 
	private JPanel bottomPanel = new JPanel();
	private JLabel searchLabel;  // 검색라벨
	private JButton aim;  // 검색버튼
	private JTextField searching;  // 검색 텍스트필드
	private JLabel pagebarLabel;	//페이지표기 바
	private JLabel preNumber = new JLabel("");  // 전페이지
	private JLabel commingNumber;  // 다음페이지
	public static int frontPage = 1;
	private JButton preBtn = new JButton(); // 앞페이지 버튼
	private JButton commingBtn = new JButton(); // 뒷 페이지 버튼
	private JLabel postList;	// 게시물목록
	...
	private JLabel localName;  // 지역 라벨
	...
	protected void postList(int postNo) {
		System.out.println("postList 호출됨");
		int pageNo = frontPage;
		int y = 153;
