...
public class SearchBoard {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SearchBoard window = new SearchBoard();
	...
	private void initialize() {
		...
		achivement.setIcon(new ImageIcon(SearchBoard.class.getResource("/common/Group 1010.png")));
		achivement.setBounds(179, 172, 70, 39);
		panel_3.add(achivement);
		
		JLabel exId = new JLabel("");
		exId.setIcon(new ImageIcon(SearchBoard.class.getResource("/search/exId.png")));
		exId.setBounds(101, 170, 80, 43);
		panel_3.add(exId);
		
		JLabel profile = new JLabel("");
		profile.setIcon(new ImageIcon(SearchBoard.class.getResource("/member/updateInfo/pf3.png")));
		profile.setBounds(40, 163, 57, 50);
		panel_3.add(profile);
		
		JLabel locationLabel = new JLabel("");
		locationLabel.setIcon(new ImageIcon(SearchBoard.class.getResource("/search/Rectangle 30.png")));
		locationLabel.setBounds(366, 169, 66, 21);
		panel_3.add(locationLabel);
		
		JButton heart = new JButton("");
		heart.setIcon(new ImageIcon(SearchBoard.class.getResource("/search/like (1) 23.png")));
		...
		aim.setIcon(new ImageIcon(SearchBoard.class.getResource("/search/aim.png")));
		...
		panel2lFrame.setIcon(new ImageIcon(SearchBoard.class.getResource("/search/cutframe.png")));
