package com.devs.honddoni.search.view.useless;
	...
	public class AllBoardListCopyHon extends JPanel{
	

		private AllBoardListCopyHon allBoardListCopyHon;
		...
		/* 프레임을 제외한 나머지를 합친 것 */
		public AllBoardListCopyHon(MainFrame frame) {

			this.frame = frame;
			this.allBoardListCopyHon = this;
		...
		public void beforeBtn() {
			int pageNo = AllBoardListCopyHon.frontPage2;
			...
			if(pageNo < 2) {
				...
				System.out.println("frontPage : " + AllBoardListCopyHon.frontPage2);
				beforeBtn.addActionListener(new ActionListener() {
					@Override
					public void actionPerformed(ActionEvent e) {
						if(AllBoardListCopyHon.frontPage2 >= 2 ) {
							AllBoardListCopyHon.frontPage2--;
						}

						downPanel.setVisible(false);
						AllBoardListCopyHon sf = new AllBoardListCopyHon(frame);
		...
		public void afterBtn() {
			...
			afterBtn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(AllBoardListCopyHon.frontPage2 < pageInfo.getMaxPage()) {
						AllBoardListCopyHon.frontPage2++;
					}
		...
		public void beforeNumber() {
			String frontPageString = Integer.valueOf(AllBoardListCopyHon.frontPage2).toString();
