package com.devs.honddoni.search.view.useless;
	...
	public class PostFreeBoardCopyHon extends JFrame {
	
		
		private PostFreeBoardCopyHon postFreeBoardCopyHon;
...
//		private JFrame mainFrame; // 메인프레임
		...
		/*혼또니 게시글 작성 화면 불러오기*/
		public PostFreeBoardCopyHon(MainFrame frame) {
			
			this.frame = frame;
			this.postFreeBoardCopyHon = this;
