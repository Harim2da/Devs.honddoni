...
public class FreeBoardList2 extends JPanel {
	...
	public void afterBtn() {
		...
		int totalCount = new PagingController().freeWholePostNum();
	...
	public void beforeNumber() {
		String frontPageString = Integer.valueOf(FreeBoardList.presentPage2).toString();
	...
	public void postList() {
		...
		postListDTO = new PagingController().freePostList(pageNo);
